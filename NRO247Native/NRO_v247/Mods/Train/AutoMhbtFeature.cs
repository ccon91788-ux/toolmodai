...
{
    public class AutoMhbtFeature : AutoTrainFeature, IAutoFeature
    {
        ...
        public new string CurrentState => IsRequested ? base.GetState() : "Tắt Auto / Ngoài giờ / Xong mục tiêu MHBT";

        public void ApplyMhbtSettings(
            bool enabled,
            ...
            int armorMode, bool freezePunchCd, int targetCount, string mobIdsRaw)
        {
            ...
            bool optimizeKs = false; // Luôn tắt KS vàng cho MHBT
