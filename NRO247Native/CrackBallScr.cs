...
public class CrackBallScr : mScreen
{
	...
	public override void paint(mGraphics g)
	{
		try
		{
			...
			g.drawImage(PanelG.imgXu, num4 + 11, num5 - 7, 3);
			g.drawImage(PanelG.imgLuong, num4 + 90, num5 - 8, 3);
			...
			g.drawImage(PanelG.imgLuongKhoa, num4 + 150, num5 - 7, 3);
			...
			g.drawImage(PanelG.imgTicket, num4 + 200, num5 - 7, 3);
			...
			if (step < 4)
			{
				...
				if (typePrice == 0)
				{
					g.drawImage(PanelG.imgXu, num7 + 21, num5 + 8, 3);
				}
				else
				{
					g.drawImage(PanelG.imgLuongKhoa, num7 + 21, num5 + 7, 3);
					g.drawImage(PanelG.imgLuong, num7 + 18, num5 + 7, 3);
				}
				mFont.tahoma_7_red.drawString(g, " -" + cost, num7 + 30, num5 + 2, mFont.LEFT, mFont.tahoma_7_grey);
				g.drawImage(PanelG.imgTicket, num7 + 80, num5 + 7, 3);
