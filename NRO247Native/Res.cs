...
public class Res
{
	...
	public static void outz(string s, int logIndex)
	{
		if (mSystem.isTest)
		{
			Debug.WriteLine(LOG_CAT[logIndex] + s);
		}
	}
	...
	public static string formatNumber2(long number)
	{
		...
		if (number >= 1000000000)
		{
			...
			if (num >= 10)
			{
				...
				string text4 = empty;
				return text4 + "," + num + empty2;
			}
			if (num > 0)
			{
				string text6 = empty;
				return text6 + ",0" + num + empty2;
			}
			return empty + empty2;
		}
		if (number >= 1000000)
		{
			...
			if (num2 >= 10)
			{
				...
				string text5 = empty;
				return text5 + "," + num2 + empty2;
			}
			if (num2 > 0)
			{
				string text3 = empty;
				return text3 + ",0" + num2 + empty2;
			}
			return empty + empty2;
		}
		if (number >= 10000)
